<template>
 <div class="flex justify-center items-center">
    <div class="flex flex-col bg-gray-300 justify-center lg:mt-8 max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-200 dark:text-gray-400">
		...
		<div class="space-y-4 text-center divide-y divide-gray-700">
			<div class="my-2 space-y-1">
				<h2 class="text-xl font-semibold sm:text-2xl"> {{ currentUser.username }} </h2>
				<p class="px-5 text-xs sm:text-base dark:text-gray-400"> Ex (  {{ currentUser.exp }} ) </p>
			</div>
