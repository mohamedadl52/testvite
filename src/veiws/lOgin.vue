                        ...
                        <div class="squre" style="--i :4;"></div>
                             <div class="form px-10">
                                ...
                                <h2>صفحة تسجيل الدخول</h2>
                                     ...
                                     <div class="inputBox">
                                         <input type="submit" @click.prevent="handleLogin(user)" class="font-semibold cursor-pointer" value="تسجيل الدخول" >
                                     </div>
                                     <p class="inputBox bg-maincolor py-2 w-full text-center  lg:text-gray-400"> اذا ليس لديك حساب مسبق قم بـ<router-link to="/signup" class=" w-full text-blue-800 underline  p-2 "> تسجيل جديد</router-link></p>
